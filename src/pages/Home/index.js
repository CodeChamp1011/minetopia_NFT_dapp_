          ...
          <ul className="list">
            ...
            <li className="items">
              <a
                className="nav-item"
                target="_blank"
                href="https://www.dropbox.com/s/z4ns0sa997ojlcb/Minetopia%20Whitepaper.pdf?dl=0"
              >
                Whitepaper
              </a>
            </li>
            <li class="nav-item items dropdown">
              ...
              <div class="dropdown-content">
                <a
                  className="sub-item"
                  href="https://www.dropbox.com/s/1ylmx5c28rgt60q/Minetopia%20Audit.pdf?dl=0"
                  target="_blank"
                >
                  {" "}
                  Report
                ...
                <a
                  className="sub-item"
                  href="https://www.dropbox.com/s/mkgqnxgqxf7jib1/Minetopia_Audit_Certificate.jpg?dl=0"
                  target="_blank"
                >
                  {" "}
                  Certificate
